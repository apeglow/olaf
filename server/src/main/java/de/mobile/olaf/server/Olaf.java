...
public class Olaf {
    ...
    public final static List<PartnerSite> ipAddress2SiteMap = Arrays.asList(
        new PartnerSite("mobile.de", Country.DE, PartnerSiteType.MOTORS_CLASSIFIED, PartnerNotifierType.REST, URI
                .create("http://localhost:8080/olaf_rest_service")),
        new PartnerSite("marktplaats", Country.NL, PartnerSiteType.GENERAL_CLASSIFIED, PartnerNotifierType.REST, URI
                .create("http://localhost:8080/olaf_rest_service")),
        new PartnerSite("annunci", Country.IT, PartnerSiteType.GENERAL_CLASSIFIED, PartnerNotifierType.REST, URI
                .create("http://localhost:8080/olaf_rest_service")));//
    ...
    public Olaf() {
        ...
        epServiceProvider //
                .getEPAdministrator() //
                .createEPL(
                    "create window RatedIpAddressWindow.win:time(360 min) as " + "select * from "
                            + RatedIpAddress.class.getName());
